        ...
        <div id="wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form method="post" name="form_add" action="gerenciar_cliente.do">
                            ...
                            <fieldset class="mt-5 border p-2 mb-4">
                                ...
                                <div class="form-group row mb-4">
                                    <div class="col-md-5">
                                        <label>Nome</label>
                                        <input type="text" class="form-control" name="nome" placeholder="Seu nome" value="${cliente.nome}" maxlength="45" required=""> 
                                    </div>
                                    <div class="col-md-4">
                                        <label>Email</label>
                                        <input type="email" class="form-control" name="email" placeholder="Seu email" value="${cliente.email}" maxlength="45" required="">
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        <label>RG</label>
                                        <input type="text" class="form-control" name="rg" placeholder="Seu RG" value="${cliente.rg}" maxlength="9" required="">
                                    </div>
                                    <div class="col-md-3">
                                        <label>Telefone</label>
                                        <input type="text" class="form-control" name="telefone" placeholder="Seu telefone" value="${cliente.telefone}" maxlength="16" required="">
                                    </div>
                                    <div class="col-md-3">
                                        <label>Sexo</label>
                                        <select class="custom-select" name="sexo"  required="">
                                            ...
                                            <option value="O" <c:if test="${cliente.sexo == 'O'}">selected=""</c:if> >Outros</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
