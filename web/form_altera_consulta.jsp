...
<%@page import="model.ServicoConsultaDAO"%>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered pb-6" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <jsp:useBean class="model.ServicoConsultaDAO" id="csDAO" />
                            <tbody>
                                <c:forEach var="cs" items="${csDAO.getCarregaPorId(consulta.idConsulta)}">
                                    <tr>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="custom-select" name="status" required="">
                                            ...
                                            <option value="cancelado" <c:if test="${consulta.status == 'cancelado'}">selected=""</c:if>>Cancelado</option>
                                            <option value="aberto" <c:if test="${consulta.status == 'aberto'}">selected=""</c:if>>Em Aberto</option>
                                            <option value="finalizado" <c:if test="${consulta.status == 'finalizado'}">selected=""</c:if>>Finalizado</option>
                                        </select>
                                    </div>
                                </div>
                            </fieldset>
